...
Hi this is greg, all of my comments will be put on the bottom with the code line so it is easier to read. 
...
Hi, this is greg my commentary will be below.

line 39-57
  Great job with this code! The code for question one is very well done and way more efficient than the way that I did it. 

line 98-112
  very interesting and well done. Placing all of these together looks very good

lines 130-150
  great job with question 3.

line 193
  I could not get this line of code to work. I got this error "Error in plot.new() : figure margins too large". This could have been an error on my part because the code looks good.

Line 323 & 365
  I also could not get line 323 to work. It states that there was an error in the variable labeled select. Again, this is probable an error on my part as your code looks very good. You did a great job with this assignemnt and clearly put a lot of time and effort into it. Have a great day!
