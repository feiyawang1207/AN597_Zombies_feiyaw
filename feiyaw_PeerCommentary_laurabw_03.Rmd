...
## Homework 3 - This file includes comments from Laura Brubaker-Wittman, all at the end of the document. 
...
```{r}
library(knitr)
#install the package of knitr before this step
kable(table1)
```
...
Like the first question, to make table look nice, we can do kable()
```{r}
library(knitr)
kable(t)
```
...
From the graph, all pf them have normal distribution, even the poplution are not normal distribution. 
...
## Comments from Laura Brubaker-Wittman:

Around line 48, at the end of question #1, I **LOVE** what you did as far as creating the function for population
standard deviation and then applying it to each of the variables we wanted to calcualte at the same time and
putting it into a nice table! That made it so easy to read and have all the information together, and defintiely
something I will think about how to incorporate into my future work.

Again, with question #2, though I got the same answers as you, I feel like I am learning a lot from your code as
far as how I could improve my visuals. Your tables are easy to read, your code is streamlined, and it makes
understanding the data that much easier. Awesome job! I defnitely will add {ggpubr} to my package library!

Some of your histograms that go along with your QQplots look different than what I got, but I think that is
because I did not have my historgram set up to show negative numbers. I was also unsure what to think of the
distributions that showed up as not normal on the QQplots. Poisson may be correct as I know it usually relates to
count data over a specific interval of time? I will be interested to hear what Dr. Schmitt says about these.

Like how you once again combined and streamlined data so that it all showed up in one table. This really helped
with comparing data.

Overall, amazing job! Looks great.
